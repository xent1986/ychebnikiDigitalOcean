...
//  $info = "";
 ...
 {
   $matches=array();
   if (preg_match('/(<td><div class="lh1px.*Набор доступных способов доставки зависит от населённого пункта и выбранных вами товаров.*<li><a href="\/my\/helper_100">Ограничения по доставке<.*<\/td>)/Uis',$str,$matches))
   {
